...
static void* thread_do(void* thread_p_void);
...
static void thread_init (thpool_* thpool_p, struct thread** thread_p, int id){
    ...
    *thread_p = (struct thread*)malloc(sizeof(struct thread));
    ...
    void* thread_p_void = *thread_p;

    pthread_create(&(*thread_p)->pthread, NULL, thread_do, thread_p_void);
...
//static void thread_hold (int dummy) {
//    threads_on_hold = 1;
...
*/
static void* thread_do(void* thread_p_void){
    struct thread* thread_p = reinterpret_cast<struct thread*>(thread_p_void);
