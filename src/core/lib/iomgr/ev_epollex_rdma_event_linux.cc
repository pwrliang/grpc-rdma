...
//   RDMASenderReceiverEvent* rdmasr = fd->rdmasr;
//   fd->rdmasr = nullptr;
...
//   const int rdma_send_channel_fd = fd->rdmasr->get_send_channel_fd();
...
//   if (epoll_ctl(epfd, EPOLL_CTL_ADD, rdma_send_channel_fd, &ev_fd) != 0) {
//     switch (errno) {
//       case EEXIST:
//         break;
//       default:
