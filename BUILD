...
grpc_cc_library(
    ...
    srcs = [
        ...
        "src/core/lib/rdma/log.cc",
        "src/core/lib/rdma/RDMAConn.cc",
        "src/core/lib/rdma/RDMAConnBP.cc",
        "src/core/lib/rdma/RDMAConnEvent.cc",
        "src/core/lib/rdma/RDMASenderReceiver.cc",
    ...
    hdrs = [
        ...
        "src/core/lib/rdma/log.h",
        "src/core/lib/rdma/RDMAConn.h",
        "src/core/lib/rdma/RDMASenderReceiver.h",
        "src/core/lib/rdma/RDMAUtils.h",
        "src/core/lib/rdma/ringbuffer.h",
